...
import Old_amonita from './images/Old_amonita.jpg'
...
export const allMushrooms = [
  {
    ...
    picdetail1: FlyAgaric,
    picdetail2: BigAmanitaTop,
    picdetail3: BigTwoBabyAmanita,
    picdetail4: ThreeBigAmanitaTop,
    picdetail5: Old_amonita,
    picdetail6: Baby_amanita,
    picdetail7: Baby_amanita1,
    picdetail8: Baby_amanita_bite1,
